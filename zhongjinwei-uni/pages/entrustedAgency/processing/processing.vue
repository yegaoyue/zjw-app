		...
		<scroll-view scroll-y="true" class="scroll-Y">
			<view class="box">
				<view class="list " v-for="item in list" @click="details(item)">
					<view class="left">
						<image src="../../../static/images/06.png"></image>
					</view>
					<view class="right">
						...
						<view class="right_bottom">
							...
							<text style="background-color: #42b699;color: #fff;padding: 4rpx 10rpx;border-radius: 4rpx;font-size: 20rpx;float: right;margin-right: 16rpx;">{{item.maState}}</text>
						</view>
					</view>
				</view>
			</view>
